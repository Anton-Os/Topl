...
struct Beams_VertexShader_GL4 : public Beams_VertexShader {
	Beams_VertexShader_GL4() : Beams_VertexShader(genPrefix_glsl() + "beams/" + "Vertex.glsl") {}
	Beams_VertexShader_GL4(unsigned mode) : Beams_VertexShader(genPrefix_glsl() + "beams/" + "Vertex.glsl", mode) {}
};

struct Beams_VertexShader_DX11 : public Beams_VertexShader {
	Beams_VertexShader_DX11() : Beams_VertexShader(genPrefix_hlsl() + "beams/" + "Vertex.hlsl") {}
	Beams_VertexShader_DX11(unsigned mode) : Beams_VertexShader(genPrefix_hlsl() + "beams/" + "Vertex.hlsl", mode) {}
};
...
struct Beams_PixelShader_GL4 : public Beams_PixelShader {
	Beams_PixelShader_GL4() : Beams_PixelShader(genPrefix_glsl() + "beams/" + "Frag.glsl") {}
};

struct Beams_PixelShader_DX11 : public Beams_PixelShader {
	Beams_PixelShader_DX11() : Beams_PixelShader(genPrefix_hlsl() + "beams/" + "Pixel.hlsl") {}
};