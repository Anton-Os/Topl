...
struct Effect_VertexShader_GL4 : public Effect_VertexShader {
    Effect_VertexShader_GL4() : Effect_VertexShader(genPrefix_glsl() + "effect/" + "Vertex.glsl"){}
	Effect_VertexShader_GL4(unsigned mode) : Effect_VertexShader(genPrefix_glsl() + "effect/" + "Vertex.glsl", mode){}
};

struct Effect_VertexShader_DX11 : public Effect_VertexShader {
    Effect_VertexShader_DX11() : Effect_VertexShader(genPrefix_hlsl() + "effect/" + "Vertex.hlsl"){}
	Effect_VertexShader_DX11(unsigned mode) : Effect_VertexShader(genPrefix_hlsl() + "effect/" + "Vertex.hlsl", mode){}
};
...
struct Effect_PixelShader_GL4 : public Effect_PixelShader {
	Effect_PixelShader_GL4() : Effect_PixelShader(genPrefix_glsl() + "effect/" + "Frag.glsl") { }
};

struct Effect_PixelShader_DX11 : public Effect_PixelShader {
	Effect_PixelShader_DX11() : Effect_PixelShader(genPrefix_hlsl() + "effect/" + "Pixel.hlsl") { }
};
