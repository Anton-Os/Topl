...
struct Idle_VertexShader_GL4 : public Idle_VertexShader {
	Idle_VertexShader_GL4() : Idle_VertexShader(genPrefix_glsl() + "idle/" + "Vertex.glsl") {}
};
...
struct Idle_VertexShader_DX11 : public Idle_VertexShader {
	Idle_VertexShader_DX11() : Idle_VertexShader(genPrefix_hlsl() + "idle/" + "Vertex.hlsl") {}
};
...
struct Idle_PixelShader_GL4 : public Idle_PixelShader {
	Idle_PixelShader_GL4() : Idle_PixelShader(genPrefix_glsl() + "idle/" + "Frag.glsl") {}
};

struct Idle_PixelShader_DX11 : public Idle_PixelShader {
	Idle_PixelShader_DX11() : Idle_PixelShader(genPrefix_hlsl() + "idle/" + "Pixel.hlsl") { }
};
