...
struct Idle_VertexShader_GL4 : public Idle_VertexShader {
	Idle_VertexShader_GL4() : Idle_VertexShader(std::string("legacy/idle/glsl/") + "Vertex.glsl") {}
};
...
struct Idle_VertexShader_DX11 : public Idle_VertexShader {
	Idle_VertexShader_DX11() : Idle_VertexShader(std::string("legacy/idle/hlsl/") + "Vertex.hlsl") {}
};
...
struct Idle_PixelShader_GL4 : public Idle_PixelShader {
	Idle_PixelShader_GL4() : Idle_PixelShader(std::string("legacy/idle/glsl/") + "Frag.glsl") {}
};

struct Idle_PixelShader_DX11 : public Idle_PixelShader {
	Idle_PixelShader_DX11() : Idle_PixelShader(std::string("legacy/idle/hlsl/") + "Pixel.hlsl") { }
};
