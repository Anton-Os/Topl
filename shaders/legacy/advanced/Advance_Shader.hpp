...
struct Advance_TessCtrlShader_GL4 : public Advance_TessCtrlShader {
	Advance_TessCtrlShader_GL4() : Advance_TessCtrlShader(std::string("legacy/advanced/glsl/") + "TessCtrl.glsl"){
		_embedMap.insert({ "Tess_Ctrl_Output", "layout(vertices = 3) out;" });
	}
	Advance_TessCtrlShader_GL4(std::string outputStr) : Advance_TessCtrlShader(std::string("legacy/advanced/glsl/") + "TessCtrl.glsl"){
		_embedMap.insert({ "Tess_Ctrl_Output", outputStr });
	}
};

struct Advance_TessCtrlShader_DX11 : public Advance_TessCtrlShader {
	Advance_TessCtrlShader_DX11() : Advance_TessCtrlShader(std::string("legacy/advanced/hlsl/") + "Hull.hlsl"){
...
struct Advance_TessEvalShader_GL4 : public Advance_TessEvalShader {
	Advance_TessEvalShader_GL4() : Advance_TessEvalShader(std::string("legacy/advanced/glsl/") + "TessEval.glsl"){ 
		_embedMap.insert({ "Tess_Eval_Input", "layout(triangles, equal_spacing, ccw) in;" });
	}
	Advance_TessEvalShader_GL4(std::string inputStr) : Advance_TessEvalShader(std::string("legacy/advanced/glsl/") + "TessEval.glsl"){ 
		_embedMap.insert({ "Tess_Eval_Input", inputStr });
	}
};

struct Advance_TessEvalShader_DX11 : public Advance_TessEvalShader {
	Advance_TessEvalShader_DX11() : Advance_TessEvalShader(std::string("legacy/advanced/hlsl/") + "Domain.hlsl"){ 
...
struct Advance_GeometryShader_GL4 : public Advance_GeometryShader {
	Advance_GeometryShader_GL4() : Advance_GeometryShader(std::string("legacy/advanced/glsl/") + "Geometry.glsl"){
	...
	Advance_GeometryShader_GL4(std::string inputStr, std::string outputStr) : Advance_GeometryShader(std::string("legacy/advanced/glsl/") + "Geometry.glsl"){
...
struct Advance_GeometryShader_DX11 : public Advance_GeometryShader {
	Advance_GeometryShader_DX11() : Advance_GeometryShader(std::string("legacy/advanced/hlsl/") + "Geometry.hlsl"){
...
struct Advance_ComputeShader_GL4 : public Advance_ComputeShader {
	Advance_ComputeShader_GL4() : Advance_ComputeShader(std::string("legacy/advanced/glsl/") + "Compute.glsl"){ 
...
struct Advance_ComputeShader_DX11 : public Advance_ComputeShader {
	Advance_ComputeShader_DX11() : Advance_ComputeShader(std::string("legacy/advanced/hlsl/") + "Compute.hlsl"){ 
