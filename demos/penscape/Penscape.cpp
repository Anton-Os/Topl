...
void Penscape_Demo::createBrushes() {
    ...
    for (unsigned b = 0; b < PENSCAPE_SEGMENTS; b++)
        for (unsigned a = 0; a < 3 * 2; a++) {
            ...
            trigMeshBrushes[a % 3]->rotate(getStepTransform(PENSCAPE_ROT));
            ...
            quadMeshBrushes[a % 3]->rotate(getStepTransform(PENSCAPE_ROT));
            ...
            hexMeshBrushes[a % 3]->rotate(getStepTransform(PENSCAPE_ROT));
            ...
            circleMeshBrushes[a % 3]->rotate(getStepTransform(PENSCAPE_ROT));
