...
struct Genesis_Demo : public Topl_Demo {
    Genesis_Demo(const char* execPath) : Topl_Demo(execPath, "Genesis"){}
    Genesis_Demo(const char* execPath, BACKEND_Target backend) : Topl_Demo(execPath, "Genesis", backend){}
