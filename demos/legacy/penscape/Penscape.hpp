...
struct Penscape_Demo : public Topl_Demo {
    Penscape_Demo(const char* execPath) : Topl_Demo(execPath, "Penscape"){}
    Penscape_Demo(const char* execPath, BACKEND_Target backend) : Topl_Demo(execPath, "Penscape", backend){}
