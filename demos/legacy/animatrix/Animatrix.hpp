...
struct Animatrix_Demo : public Topl_Demo {
    Animatrix_Demo(const char* execPath) : Topl_Demo(execPath, "Animatrix"){}
    Animatrix_Demo(const char* execPath, BACKEND_Target backend) : Topl_Demo(execPath, "Animatrix", backend){}
