...
struct Topl_Sampler_UI : Topl_Sampler_Array {
#ifdef TOPL_ENABLE_TEXTURES
	Topl_Sampler_UI(enum MENU_Size s){ size = s; }

	~Topl_Sampler_UI(){ RASTERON_QUEUE_DEALLOC(queue); }
...
struct Topl_Sampler_Button : public Topl_Sampler_UI {
#ifdef TOPL_ENABLE_TEXTURES
	Topl_Sampler_Button() : Topl_Sampler_UI(MENU_Medium){
		queue = loadUI_checkBtn(MENU_Medium); 
		Topl_Sampler_UI::setState(MENU_None);
	}

	Topl_Sampler_Button(enum MENU_Size size) : Topl_Sampler_UI(size){
		queue = loadUI_checkBtn(size); 
		Topl_Sampler_UI::setState(MENU_None);
	}

	Topl_Sampler_Button(char* iconName) : Topl_Sampler_UI(MENU_Medium){ 
		queue = loadUI_iconBtn(MENU_Medium, iconName);
		Topl_Sampler_UI::setState(MENU_None);
	}

	Topl_Sampler_Button(enum MENU_Size size, char* iconName) : Topl_Sampler_UI(size){ 
...
struct Topl_Sampler_Label : public Topl_Sampler_UI {
#ifdef TOPL_ENABLE_TEXTURES
#if RASTERON_ENABLE_FONT
	Topl_Sampler_Label(Rasteron_Text textObj) : Topl_Sampler_UI(MENU_Medium){
		queue = RASTERON_QUEUE_ALLOC("label", RASTERON_SIZE(104, 104), 4); // TODO: Make size correct?
		setText(textObj);
		Topl_Sampler_UI::setState(MENU_None);
	}

	Topl_Sampler_Label(enum MENU_Size size, Rasteron_Text textObj) : Topl_Sampler_UI(size){
		queue = RASTERON_QUEUE_ALLOC("label", RASTERON_SIZE(104, 104), 4); // TODO: Make size correct?
		setText(textObj);
		Topl_Sampler_UI::setState(MENU_None);
	}
...
#else
	Topl_Sampler_Label() : Topl_Sampler_UI(MENU_Medium) {}
#endif
#endif
};

struct Topl_Sampler_Dial : public Topl_Sampler_UI {
#ifdef TOPL_ENABLE_TEXTURES
	Topl_Sampler_Dial(unsigned short count) : Topl_Sampler_UI(MENU_Medium){ 
		queue = loadUI_dial(MENU_Medium, count); 
		Topl_Sampler_UI::setState(MENU_None);
	}

	Topl_Sampler_Dial(enum MENU_Size size, unsigned short count) : Topl_Sampler_UI(size){ 
	...
	void setState(double x, double y){
		...
		Topl_Sampler_UI::setState(index);
	}
#endif
};

struct Topl_Sampler_Slider : public Topl_Sampler_UI {
#ifdef TOPL_ENABLE_TEXTURES
	Topl_Sampler_Slider(unsigned short count) : Topl_Sampler_UI(MENU_Medium){ 
		queue = loadUI_slider(MENU_Medium, count); 
		Topl_Sampler_UI::setState(MENU_None); // start positino
	}

	Topl_Sampler_Slider(enum MENU_Size size, unsigned short count) : Topl_Sampler_UI(size){ 
...
struct Topl_Sampler_Layout : public Topl_Sampler_UI {
#ifdef TOPL_ENABLE_TEXTURES
#if RASTERON_ENABLE_FONT
	Topl_Sampler_Layout(SIDE_Type side, Rasteron_Text text, Rasteron_Image* image, unsigned bkColor) : Topl_Sampler_UI(MENU_Medium){ 
		setLayout(side, text, image, bkColor);
		Topl_Sampler_UI::setState(MENU_None);
	}

	Topl_Sampler_Layout(enum MENU_Size size, SIDE_Type side, Rasteron_Text text, Rasteron_Image* image, unsigned bkColor) : Topl_Sampler_UI(size){ 
		setLayout(side, text, image, bkColor);
		Topl_Sampler_UI::setState(MENU_None);
	}
