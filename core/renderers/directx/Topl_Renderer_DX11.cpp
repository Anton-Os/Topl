...
Topl_Sampler_2D Topl_Renderer_DX11::frame() {
	HRESULT result;
...
void Topl_Renderer_DX11::attachTexAt(const Topl_Sampler_2D* image, unsigned renderID, unsigned binding) {
	HRESULT result;
...
void Topl_Renderer_DX11::attachTex3D(const Topl_Sampler_3D* volumeTex, unsigned renderID) {
	HRESULT result;
