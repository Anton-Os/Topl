...
Topl_Sampler_2D Topl_Renderer_VK::frame() {
	_frameImage = Topl_Sampler_2D();
	// _frameImage.setColorImage(CLEAR_COLOR_CODE);
	return _frameImage;
}

void Topl_Renderer_VK::attachTexAt(const Topl_Sampler_2D* image, unsigned renderID, unsigned binding) {
	// Create Data
...
void Topl_Renderer_VK::attachTex3D(const Topl_Sampler_3D* volumeTex, unsigned renderID) {
	// Create Data
