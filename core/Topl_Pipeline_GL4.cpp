...
Topl_Pipeline_GL4 Topl_Renderer_GL4::genPipeline(entry_shader_cptr vertexShader, shader_cptr fragShader){
	Topl_Pipeline_GL4 pipeline = Topl_Pipeline_GL4(vertexShader);
	GLint result;
	const char* source;
...
Topl_Pipeline_GL4 Topl_Renderer_GL4::genPipeline(entry_shader_cptr vertexShader, shader_cptr fragShader, shader_cptr tessCtrlShader, shader_cptr tessEvalShader, shader_cptr geomShader){
	Topl_Pipeline_GL4 pipeline = Topl_Pipeline_GL4(vertexShader);
	GLint result;
	const char* source;
