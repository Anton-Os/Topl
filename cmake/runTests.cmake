...
target_include_directories(Test_Diagnostic PRIVATE core helper geometry shaders ${RESOURCE_DIR})
target_link_libraries(Test_Diagnostic PRIVATE CORELIB)

add_executable(Test_HelloVulkan demos/test/HelloVulkan.cpp)
target_include_directories(Test_HelloVulkan PUBLIC core helper geometry shaders ${RESOURCE_DIR})
...
target_include_directories(Test_OddShapes PUBLIC helper geometry)
...
target_include_directories(Test_StateSaves PUBLIC core helper geometry)
