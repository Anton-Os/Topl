...
struct Geo_ExtCone : public Geo_Cone { // expands base into repeating portions
    ...
    DllExport Geo_ExtCone(Shape2D shape, Vec3f apex, unsigned short iters);
    // Geo_ExtCone(vertex_cptr_t points, unsigned short pointCount, Vec3f apex);
    DllExport Geo_ExtCone(vertex_cptr_t points, unsigned short pointCount, Vec3f apex, unsigned short iters);
